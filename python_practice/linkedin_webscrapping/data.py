...
email = "jayanthkumar@live.com"
password = "Jayanth@2003"
...
for i in range(1,41):
    ...
    for job in range (1, len(jobs)+1):
        ## job click
        driver.find_element_by_xpath(f'/html/body/div[5]/div[3]/div[3]/div[2]/div/section[1]/div/div/ul/li[{job}]/div/div/div[1]/div[2]/div[1]/a').click()
        ## waiting load 
        time.sleep(1)
